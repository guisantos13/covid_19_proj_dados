class FundoImobiliario:
    def __init__(self,codigo,segmento,cotacao_atual,ffo_yield,dividend_yield,p_vp,valor_mercado,liquidez,qt_imoveis,preco_m2
...
class Estrategia:
    def __init__(self,segmento='',cotacao_atual_minima=0,ffo_yield=0,dividend_yield=0,p_vp_minimo=0,
        ...
        self.ffo_yield_minimo = ffo_yield
        self.dividend_yield_minimo = dividend_yield
